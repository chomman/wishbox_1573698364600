...
//CRUD METHODS
    ...
    //CRUD - FIND BY Owner
    @Secured({ "ROLE_PRIVATE_USER" })
	@RequestMapping(value = "/category/findByowner/{key}", method = RequestMethod.GET, headers = "Accept=application/json")
	public List<Category> findByowner(@PathVariable("key") Long idowner) {
		List<Category> list = categoryService.findByowner(idowner);
		return list;
	}
